...
/*   Updated: 2024/01/23 12:16:05 by jceron-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../fractol.h"

static void	handle_pixel(int pixel_x, int pixel_y, t_fractal *fractal)
{
	t_complex	z;
	t_complex	c;
	int			i;
	...
	mlx_put_pixel(fractal->img, pixel_x, pixel_y, LIME_SHOCK);
}
